...
- Transforma a **primeira palavra da pergunta** em um botão secreto: clicou, ele consulta a IA.
- Ao receber a resposta da OpenAI, marca automaticamente a alternativa correspondente no formulário (sem mostrar textos extras na tela).
- Indica sucesso/erro apenas mudando brevemente a cor da palavra-botão (bem discreto).
...
4. Abra qualquer questionário do Google Forms. Clique na **primeira palavra da pergunta** para acionar a IA; a alternativa será marcada automaticamente.
